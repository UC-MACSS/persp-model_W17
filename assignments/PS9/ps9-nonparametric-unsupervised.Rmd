...
1. Split the data into a training and test set (70/30).
1. Calculate the test MSE for KNN models with $K = 1,2,\dots,10$, using whatever combination of variables you see fit. Which model produces the lowest test MSE?
1. Calculate the test MSE for weighted KNN models with $K = 1,2,\dots,10$ using the same combination of variables as before. Which model produces the lowest test MSE?
