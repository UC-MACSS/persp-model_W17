...
if True:
    ...
    '''
    ------------------------------------------------------------------------
    Exercise 1b: 1 step GMM with mean and std
    ------------------------------------------------------------------------
    '''
    if True:
    ...
    '''
    ------------------------------------------------------------------------
    Exercise 1c: 2 step GMM with mean and std
    ------------------------------------------------------------------------
    '''
    if True:
    ...
    '''
    ------------------------------------------------------------------------
    Exercise 1d: 1 step GMM with three proportion moments
    ------------------------------------------------------------------------
    '''
    if True:
        ...
        err1 = err_vec3(df['incomes'], mu_GMM1_3, sig_GMM1_3, np.inf, True).reshape(3,)
    ...
    '''
    ------------------------------------------------------------------------
    Exercise 1e: 2 step GMM with three proportion moments
    ------------------------------------------------------------------------
    '''
    if True:
        err1 = err_vec3(df['incomes'], mu_GMM1_3, sig_GMM1_3, np.inf, True)
        VCV2 = np.dot(err1, err1.T) / df['incomes'].shape[0]
        # print(VCV2)
        W_hat2 = lin.pinv(VCV2)  # Use the pseudo-inverse calculated by SVD because VCV2 is ill-conditioned
        # print(W_hat2)
        ...
        dist_pts = np.linspace(0, 160000, 500)
        plt.plot(dist_pts, lognorm_pdf(dist_pts, mu_GMM2, sig_GMM2, np.inf),
                 linewidth=2, color='g', label='1: $\mu_{GMMc}$,$\sigma_{GMMc}$')
        plt.plot(dist_pts, lognorm_pdf(dist_pts, mu_GMM2_3, sig_GMM2_3, np.inf),
                 linewidth=2, color='r', label='2: $\mu_{GMMe}$,$\sigma_{GMMe}$')
        plt.legend(loc='upper left')
        plt.savefig('1c+1e')
...
if True:
    '''
    ------------------------------------------------------------------------
    Exercise 2a: Linear regression and GMM
    ------------------------------------------------------------------------
    '''
