...
# plot all models
set.seed(1234)
biden_models <- list("Bagging" = randomForest(biden ~ ., data = biden_bag_data_train,
                                                mtry = 5, ntree = 500),
                       "Random Forest (m=2)" = randomForest(biden ~ ., data = biden_bag_data_train,
                                                 mtry = 2, ntree = 500),
...
yhat=predict(biden_tree ,newdata=biden.split$test)
boston.test=biden.split$test["biden"]
yhat.boost=predict(biden_boost_1,newdata=biden_bag_data_test, n.trees=3293)
