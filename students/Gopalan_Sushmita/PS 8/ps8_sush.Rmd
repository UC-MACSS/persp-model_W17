...
We see that using a depth of 2 with 2620 trees gives us an MSE value that is lowest, although only marginal less than (depth = 1, trees = 3302) and (depth = 4, trees = 2094).
