...
data1 %>%
  ...
  labs(title = "Observed voter turnout by mental health state",
...
ggplot(vote_mental_pred, aes(x = mhealth_sum)) +
  ...
  labs(title = "Log-odds of voter turout for different mental health states",
       x = "Mental health",
...
ggplot(vote_mental_pred, aes(x = mhealth_sum)) +
  ...
  labs(title = "Odds of voter turout for different mental health states",
       x = "Mental health",
...
cat("The difference in probability for an increase in the mental health index from 1 to 2 is", diff_1to2_mul)
cat("The difference in probability for an increase in the mental health index from 5 to 6 is", diff_5to6_mul)
```
