...
1. `educ` - Highest year of formal schooling completed   
1. `female` - 1 if female, 0 if male   
1. `hrsrelax` - Hours per day respondent has to relax  
1. `black` - 1 if respondent is black, 0 otherwise   
1. `social_connect` - Ordinal scale of social connectedness, with values low-moderate-high (0-1-2)   
1. `voted04` - 1 if respondent voted in the 2004 presidential election, 0 otherwise   
1. `xmovie` - 1 if respondent saw an X-rated movie in the last year, 0 otherwise   
