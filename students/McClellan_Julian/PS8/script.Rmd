...
err_rate_comp = data_frame(tree_types = c('Standard Tree', 'Optimally Pruned', 'Bagged', 'Random Forest', 'Boosted'))
...
mhealth_boost <- gbm(vote96 ~ ., 
                   data = mhealth.split$train, distribution = 'huberized',
                   n.trees = 5000, interaction.depth = int_depth)
predict(mhealth_boost, mhealth.split$test$data, n.trees = 100, class = 'response')
```