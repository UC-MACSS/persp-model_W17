...
bag_biden = bagging(biden ~ female + age + educ + dem + rep, biden_train70, nbagg=1000, coob=TRUE)
pred_bag_biden = predict(bag_biden, biden_test30, type="prob")
mse_bag_biden = mse(bag_biden, biden_test30)
```

Using the validation data, the model returns a test MSE of `r mse_bag_biden`, which is higher than the MSE found when pruning the tree earlier (`r mse_test30_2`).
