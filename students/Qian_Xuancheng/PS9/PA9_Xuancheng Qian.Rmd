...
* Here we calculated the test MSE for weighted KNN models with $K = 1, 2, 3, \dots, 10$ using the same combination of variables as before. From the plot, we can see that the test MSE achieves the minimum when k=`r mse_mh_knn_w_p`, which is `r mse_mh_knn_w`. 
