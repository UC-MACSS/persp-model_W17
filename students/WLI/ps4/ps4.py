...
plt.title('MACSS student income', fontsize=20)
plt.xlabel('Incomes')
...
print()
print('1b.')
print('The lognormal pdf is:')
print(LN_pdf(testxvals, testmu, testsig))
...
mu_SMM1, sig_SMM1, sim_vals = problem1c(pts, N, S, seed, mu_init, sigma_init)
...
def problem1d(pts, mu_SMM1, sig_SMM1, sim_vals, mu_init, std_init,
	...
	results = opt.minimize(criterion, params_init2, args=(args),
	...
	plt.plot(dist_pts, LN_pdf(dist_pts, mu_SMM2, sig_SMM2),
		 linewidth=2, color='k', linestyle = '--', label=
...
mu_SMM2, sig_SMM2 = problem1d(pts, mu_SMM1, sig_SMM1, sim_vals, mu_SMM1, sig_SMM1, N, S, seed)
