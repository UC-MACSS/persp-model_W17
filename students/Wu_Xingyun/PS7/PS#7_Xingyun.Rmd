...
5. Compared to the LOOCV approach, the test MSEs for the 10-fold cross-validation approach are lower.
...
6. Repeat the 10-fold cross-validation approach 100 times, using 100 different splits of the observations into 10-folds, we get the results below. The mean MSE I got is 398.1786. And according to the histogram I got, most of the MSEs are located between 397 and 399, which are lower than the single 10-fold cross-validation approach. So the 100-time 10-fold cross-validation approach is more reliable.
