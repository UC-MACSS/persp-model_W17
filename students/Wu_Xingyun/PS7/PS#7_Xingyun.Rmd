...
```{r problem1_6, ehco=FALSE}
# set random seed
set.seed(1234)

# repeat 100 times
fold10_100 <- replicate(100, {
...
fold10_100 <- mean(fold10_100)

ggplot(mapping = aes(fold10_100)) + 
   geom_histogram(color = 'black', fill = 'white') +
   labs(title = "Distribution of MSE using 10-fold Cross-Validation Approach 100 times",
        x = "MSE values",
        y = "Frequency")+
  geom_vline(aes(xintercept = fold10_100, color = '100-times 10-fold')) +
