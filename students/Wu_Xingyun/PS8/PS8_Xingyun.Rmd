...
#### Comparison
  ...
  According to the plot below and the AUC values, the fitness of values are actially very close. The logistic regression gets the largest AUC value , while the random forest provides slightly lower AUC values. And the AUC values of random forest model and the decision tree model are very close.So the logistic regression model using random forest would be the best model.
  Wholly constructed by dummy variables, the performace of the three method in this context coule be close.
